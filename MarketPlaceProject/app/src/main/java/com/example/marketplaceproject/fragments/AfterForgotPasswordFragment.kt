 ...
 * Use the [AfterForgotPasswordFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class AfterForgotPasswordFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view =  inflater.inflate(R.layout.fragment_after_forgot_password, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment AfterForgotPasswordFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AfterForgotPasswordFragment().apply {
